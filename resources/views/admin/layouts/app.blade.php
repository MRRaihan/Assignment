...
<head>
    ...
    <title>TMSS-ICT || Assignment</title>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/students" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/results" active-class="active" class="nav-link">
